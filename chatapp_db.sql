...
CREATE TABLE `chat_group` (
  ...
  CONSTRAINT `chat_group_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `user` (`user_id`)
...
CREATE TABLE `user_group` (
  ...
  CONSTRAINT `user_group_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `chat_group` (`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-20 12:29:00
